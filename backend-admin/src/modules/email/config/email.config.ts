...
export default registerAs('email', () => ({
  ...
  replyTo: process.env.EMAIL_REPLY_TO || process.env.EMAIL_FROM || 'jawabtest@pakentforum.com',
  ...
  smtp: {
    ...
    connectionTimeout: parseInt(process.env.SMTP_CONNECTION_TIMEOUT || '10000', 10), // 10 seconds
  ...
  sendgrid: {
    ...
    fromEmail: process.env.SENDGRID_FROM_EMAIL || process.env.EMAIL_FROM || 'jawabtest@pakentforum.com',
    fromName: process.env.SENDGRID_FROM_NAME || process.env.EMAIL_FROM_NAME || 'Jawab',
  },
  ...
  awsSes: {
    ...
    fromEmail: process.env.AWS_SES_FROM_EMAIL || process.env.EMAIL_FROM || 'jawabtest@pakentforum.com',
    fromName: process.env.AWS_SES_FROM_NAME || process.env.EMAIL_FROM_NAME || 'Jawab',
  },
  ...
  features: {
    ...
    subscriptionConfirmation: process.env.EMAIL_FEATURE_SUBSCRIPTION_CONFIRMATION !== 'false', // Default: true
    subscriptionExpired: process.env.EMAIL_FEATURE_SUBSCRIPTION_EXPIRED !== 'false', // Default: true
    subscriptionReminder: process.env.EMAIL_FEATURE_SUBSCRIPTION_REMINDER !== 'false', // Default: true
  ...
  templates: {
    ...
    viewsPath: process.env.EMAIL_TEMPLATES_PATH || 'src/modules/templates/views',
  },
