...
const CommentsHeader = React.memo(({
  ...
  const handleExportData = async () => {
    const params = {
      ...
      is_approved: selectedStatus === 'approved' ? true : (selectedStatus === 'pending' ? false : undefined),
  ...
  return (
    <div className="p-4 border-b border-purple-100 dark:border-gray-700 transition-colors">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-3">
        <div>
          <h3 className="text-base font-bold text-gray-800 dark:text-gray-100 transition-colors">All Comments</h3>
