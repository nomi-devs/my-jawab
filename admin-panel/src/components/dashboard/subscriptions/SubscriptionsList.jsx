  ...
  if (subscriptions.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2 transition-colors">No subscriptions found</h3>
        <p className="text-gray-500 dark:text-gray-400 transition-colors">Create your first subscription to get started</p>
      </div>
    );
  }
