...
const SubscriptionsHeader = React.memo(({
  ...
  const hasActiveFilters = localSearchTerm !== '' || selectedStatus !== "all" || selectedType !== "all" || selectedSortBy !== "created_at" || selectedSortOrder !== "DESC";
  ...
  return (
    <div className="p-4 border-b border-purple-100 dark:border-gray-700 transition-colors">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-3">
        <div>
          <h3 className="text-base font-bold text-gray-800 dark:text-gray-100 transition-colors">All Subscriptions</h3>
      ...
      <div className="flex flex-col sm:flex-row gap-2 items-start sm:items-center">
        ...
        <div className="relative flex-shrink-0">
          ...
          >
            ...
            <option value="subscription_name">Sort: Name</option>
            <option value="subscription_price">Sort: Price</option>
          </select>
        </div>
