...
const CommunityCard = React.memo(
  ({
    ...
    return (
      <div
        key={community.id}
        className={`bg-white dark:bg-gray-800 rounded-xl border overflow-hidden group transition-all hover:shadow-lg animate-fadeIn ${
          community.is_active
      ...
      >
        ...
        <div
          className={`h-24 ${community.community_image && !headerImageError ? 'bg-gray-100 dark:bg-gray-700' : community.color || 'bg-blue-500'} relative overflow-hidden`}
        >
          ...
          <div className="absolute -bottom-8 left-6">
            <div className="w-16 h-16 rounded-xl bg-white p-1 border border-purple-100 shadow-sm">
              {community.community_image && !thumbnailImageError ? (
                ...
                <div
                  className={`w-full h-full rounded-lg ${community.color || 'bg-blue-500'} opacity-80 flex items-center justify-center text-white`}
                >
            ...
            <div className="flex flex-col text-right">
              ...
              <span
                className={`font-semibold mt-1 transition-colors ${
                  community.posts_per_day >= 2
                    ? 'text-green-600 dark:text-green-400'
                    : community.posts_per_day >= 0.5
