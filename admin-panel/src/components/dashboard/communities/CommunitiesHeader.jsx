// src/components/dashboard/communities/CommunitiesHeader.jsx
import React, { useState, useEffect, useRef } from "react";
import { Users, Search, X, Filter, Grid, List, Download } from "lucide-react";
import RefreshButton from "../../common/RefreshButton";
import ExportButton from "../../common/ExportButton";
import communitiesApi from "../../../api/communitiesApi";

const CommunitiesHeader = React.memo(({
  communityCount,
  onAddClick,
  onSearch,
  onStatusFilter,
  ...
  const hasActiveFilters = localSearchTerm !== '' || selectedStatus !== "all" || selectedSortBy !== "created_at" || selectedSortOrder !== "DESC";
  ...
  const handleExportData = async () => {
    ...
    try {
      const response = await communitiesApi.exportCommunities(params);
  ...
  return (
    <div className="p-4 border-b border-purple-100 dark:border-gray-700 transition-colors">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-3">
        <div>
          <h3 className="text-base font-bold text-gray-800 dark:text-gray-100 transition-colors">All Communities</h3>
      ...
      <div className="flex flex-col sm:flex-row gap-2 items-start sm:items-center">
        ...
        <div className="relative flex-shrink-0">
          ...
          >
            ...
            <option value="members_count">Sort: Members</option>
          </select>
        </div>
...
CommunitiesHeader.displayName = "CommunitiesHeader";
