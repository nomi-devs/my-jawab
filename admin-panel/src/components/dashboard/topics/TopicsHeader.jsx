...
const TopicsHeader = React.memo(({
  ...
  const handleExportData = async () => {
    ...
    try {
      const response = await topicsApi.exportTopics(params);
  ...
  return (
    <div className="p-4 border-b border-purple-100 dark:border-gray-700 transition-colors">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-3">
        <div>
          <h3 className="text-base font-bold text-gray-800 dark:text-gray-100 transition-colors">{title}</h3>
      ...
      <div className="flex flex-col sm:flex-row gap-2 items-start sm:items-center">
        ...
        {/* Type Filter (Categories vs Subtopics) */}
        <div className="relative flex-shrink-0">
          <select
            value={selectedType}
...
TopicsHeader.displayName = "TopicsHeader";
