      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-[90%] h-[90vh] flex flex-col border border-purple-100 dark:border-gray-700 overflow-hidden transition-colors">
        ...
        <div className="flex-shrink-0 px-5 py-4 border-b border-purple-100 dark:border-gray-700 flex items-center justify-between bg-white dark:bg-gray-800 transition-colors">
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              <h3 className="text-sm font-bold text-gray-800 dark:text-gray-100 transition-colors">Add New Topic</h3>
              <p className="text-xs text-gray-500 dark:text-gray-400 transition-colors">Create a new topic to organize content</p>
            </div>
          </div>
          <button
            onClick={handleClose}
        ...
        <form id="add-topic-form" onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-hidden">
              ...
              <div className="md:col-span-2">
                <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg transition-colors">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 transition-colors">Topic will be visible to users</p>
                  </div>
