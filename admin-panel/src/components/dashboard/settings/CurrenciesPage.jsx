  ...
  const fetchCurrencies = useCallback(async () => {
    ...
    try {
      ...
      setDefaultCurrencyId(
        appCurrencySetting?.setting_value ? parseInt(appCurrencySetting.setting_value) : null,
      );
    } catch (error) {
              ...
              <tbody className="divide-y divide-purple-100 dark:divide-gray-700">
                {paginatedCurrencies.length > 0 ? (
                  paginatedCurrencies.map((currency, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-sm font-bold text-gray-700 dark:text-gray-300 text-center">
                          {currency.currency_symbol}
                        </td>
                        <td className="px-6 py-4 text-center">
                          <span
                            className={`inline-flex items-center w-fit px-2 py-0.5 rounded-full text-[10px] font-medium transition-colors ${
                              currency.is_active
                  ...
                  <tr>
                    <td
                      colSpan="7"
                      className="px-6 py-12 text-center text-gray-500 dark:text-gray-400 bg-gray-50/50 dark:bg-gray-900/50"
                    >
