    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md overflow-hidden border border-purple-100 dark:border-gray-700 animate-in zoom-in-95 duration-300">
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              ...
              {errors.currency_name && (
                <p className="text-[10px] text-red-500 flex items-center gap-1 mt-1">
                  <AlertCircle size={10} /> {errors.currency_name}
                </p>
              )}
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                {errors.currency_code && (
                  <p className="text-[10px] text-red-500 mt-1">{errors.currency_code}</p>
                )}
              </div>
              ...
              <div className="space-y-1.5">
                ...
                {errors.currency_symbol && (
                  <p className="text-[10px] text-red-500 mt-1">{errors.currency_symbol}</p>
                )}
              </div>
            </div>
          ...
          {/* Modal Footer */}
          <div className="shrink-0 flex items-center justify-end gap-3 px-6 py-4 border-t border-purple-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50">
            <button
              type="button"
              onClick={onClose}
