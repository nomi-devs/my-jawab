...
import { X, User, Mail, Shield, Calendar, MapPin, Link as LinkIcon, Heart, MessageCircle, Eye, Users, FileText, CheckCircle, XCircle, Loader2, CreditCard, Package, Image as ImageIcon } from 'lucide-react';
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-[90%] h-[90vh] flex flex-col overflow-hidden animate-slideInFromTop">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-purple-100 dark:border-gray-700">
          <div className="flex items-center space-x-3">
            {user && (
              <img
                src={profile?.profile_picture || userData?.img || `https://api.dicebear.com/7.x/avataaars/svg?seed=${user.username}`}
          ...
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                ...
                <span>{tab.label}</span>
                {tab.count !== undefined && (
                  <span className={`px-1.5 py-0.5 rounded-full text-[10px] ${activeTab === tab.id
            ...
            <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs font-medium text-gray-800 dark:text-gray-200">{user.email}</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                    ...
                    {profile && typeof profile === 'object' && Object.keys(profile).length > 0 ? (
                      <div className="space-y-4">
                        ...
                        {(profile.profile_picture || profile.profile_background) && (
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {profile.profile_picture && (
                              <div>
                                <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-2">Profile Picture</p>
                            ...
                            {profile.profile_background && (
                              <div>
                                <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-2">Profile Background</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {profile.full_name && (
                            <div>
                              <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-0.5">Full Name</p>
                              <p className="text-xs font-medium text-gray-800 dark:text-gray-200">{profile.full_name}</p>
                            </div>
                          )}
                          {profile.tagline && (
                            <div>
                              <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-0.5">Tagline</p>
                              <p className="text-xs font-medium text-gray-800 dark:text-gray-200">{profile.tagline}</p>
                            </div>
                          )}
                          {profile.profile_gender && (
                            <div>
                              <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-0.5">Gender</p>
                              <p className="text-xs font-medium text-gray-800 dark:text-gray-200 capitalize">{profile.profile_gender}</p>
                            </div>
                          )}
                          {profile.profile_birthday && (
                            <div>
                              <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-0.5">Birthday</p>
                              <p className="text-xs font-medium text-gray-800 dark:text-gray-200">
                          ...
                          {profile.profile_location && (
                            <div className="flex items-start gap-2">
                              <MapPin className="text-gray-400 dark:text-gray-500 mt-0.5" size={14} />
                              <div className="flex-1">
                                <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-0.5">Location</p>
                                <p className="text-xs font-medium text-gray-800 dark:text-gray-200">{profile.profile_location}</p>
                              </div>
                            </div>
                          )}
                          {profile.profile_website && (
                            <div className="flex items-start gap-2">
                              <LinkIcon className="text-gray-400 dark:text-gray-500 mt-0.5" size={14} />
                              <div className="flex-1">
                                <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-0.5">Website</p>
                                <a
                        ...
                        {profile.profile_bio && (
                          <div>
                            ...
                            <p className="text-xs text-gray-800 dark:text-gray-200 whitespace-pre-wrap">{profile.profile_bio}</p>
                          </div>
                        )}
                        ...
                        {(profile.created_at || profile.updated_at) && (
                          <div className="pt-3 border-t border-purple-200 dark:border-gray-600 grid grid-cols-1 md:grid-cols-2 gap-4">
                            {profile.created_at && (
                              <div>
                                <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-0.5">Profile Created</p>
                                <p className="text-xs font-medium text-gray-800 dark:text-gray-200">
                            ...
                            {profile.updated_at && (
                              <div>
                                <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-0.5">Last Updated</p>
                                <p className="text-xs font-medium text-gray-800 dark:text-gray-200">
                      ...
                      <div className="text-center py-6">
                        ...
                        <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">This user hasn't set up their profile yet.</p>
                      </div>
                    )}
                  </div>
                </div>
              ...
              {activeTab === 'posts' && (
                <div className="space-y-5">
                  {postsLoading ? (
                    ...
                    userPosts.map((post) => (
                      <div key={post.id} className="bg-purple-50 dark:bg-gray-700/50 rounded-lg px-5 py-4 hover:bg-purple-100 dark:hover:bg-gray-700 transition-colors">
                        <div className="flex items-start gap-4 mb-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start justify-between gap-4 mb-1">
                              <h4 className="font-semibold text-gray-800 dark:text-gray-100 text-sm line-clamp-1">{post.post_title || 'Untitled Post'}</h4>
                              <span className={`shrink-0 px-2 py-0.5 rounded-full text-[10px] font-medium ${post.post_status === 'published'
                ...
                <div className="space-y-4">
                  {communitiesLoading ? (
                    ...
                    userCommunities.map((community) => (
                      <div key={community.id} className="bg-purple-50 dark:bg-gray-700/50 rounded-lg p-4 hover:bg-purple-100 dark:hover:bg-gray-700 transition-colors">
                        <div className="flex items-center gap-4 mb-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start justify-between">
                              ...
                              <span className={`px-2 py-0.5 rounded-full text-[10px] font-medium ${community.is_active
                                ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400'
                                : 'bg-gray-100 text-gray-700 dark:bg-gray-600 dark:text-gray-300'
                                }`}>
                            ...
                            <p className="text-xs text-purple-600 dark:text-purple-400 mt-0.5 capitalize">{community.role || 'Member'}</p>
                          </div>
                        </div>
                ...
                <div className="space-y-5">
                  {subscriptionsLoading ? (
                    ...
                    userSubscriptions.map((subscription) => (
                      <div key={subscription.id} className="bg-purple-50 dark:bg-gray-700/50 rounded-lg p-4 hover:bg-purple-100 dark:hover:bg-gray-700 transition-colors">
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <span className={`px-2 py-1 rounded-full text-xs font-medium ${subscription.subscription_status === 'active'
                            ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400'
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          {subscription.subscription_start_date && (
                            <div>
                              <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-1">Start Date</p>
                              <p className="text-xs font-medium text-gray-800 dark:text-gray-200">
                          ...
                          {subscription.subscription_end_date && (
                            <div>
                              <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-1">End Date</p>
                              <p className="text-xs font-medium text-gray-800 dark:text-gray-200">
                          ...
                          {subscription.subscription?.subscription_price && (
                            <div>
                              <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-1">Price</p>
                              <p className="text-xs font-medium text-gray-800 dark:text-gray-200">
                                ${subscription.subscription.subscription_price}
                              </p>
                            </div>
                          ...
                          {subscription.subscription_renewal_type && (
                            <div>
                              <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-1">Renewal</p>
                              <p className="text-xs font-medium text-gray-800 dark:text-gray-200 capitalize">
                                {subscription.subscription_renewal_type}
                              </p>
                            </div>
                ...
                <div className="space-y-5">
                  {paymentsLoading ? (
                    ...
                    userPayments.map((payment) => (
                      <div key={payment.id} className="bg-purple-50 dark:bg-gray-700/50 rounded-lg p-4 hover:bg-purple-100 dark:hover:bg-gray-700 transition-colors">
                        <div className="flex items-start justify-between mb-3">
                          <div>
                            <h4 className="font-semibold text-gray-800 dark:text-gray-100">
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                              {payment.payment_method?.replace('_', ' ') || 'N/A'} • {payment.payment_gateway || 'N/A'}
                            </p>
                          </div>
                          <span className={`px-2 py-1 rounded-full text-xs font-medium ${payment.payment_status === 'completed'
                            ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400'
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          <div>
                            <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-1">Amount</p>
                          ...
                          {payment.created_at && (
                            <div>
                              <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-1">Date</p>
                              <p className="text-xs font-medium text-gray-800 dark:text-gray-200">
                          ...
                          {payment.user_subscription?.subscription?.subscription_name && (
                            <div>
                              <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-1">Subscription</p>
                              <p className="text-xs font-medium text-gray-800 dark:text-gray-200">
                                {payment.user_subscription.subscription.subscription_name}
                              </p>
                            </div>
                          ...
                          {payment.payment_currency && (
                            <div>
                              <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-1">Currency</p>
                              <p className="text-xs font-medium text-gray-800 dark:text-gray-200">
                                {payment.payment_currency}
                              </p>
                            </div>
                ...
                <div className="space-y-5">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-purple-50 dark:bg-gray-700/50 rounded-lg p-4 text-center">
                      ...
                      <p className="text-lg font-bold text-gray-800 dark:text-gray-100">{userDetails?.follower_count || 0}</p>
                      <p className="text-[10px] text-gray-500 dark:text-gray-400">Followers</p>
                    </div>
                    <div className="bg-purple-50 dark:bg-gray-700/50 rounded-lg p-4 text-center">
                      <Users className="w-6 h-6 text-purple-600 dark:text-purple-400 mx-auto mb-1.5" />
                      <p className="text-lg font-bold text-gray-800 dark:text-gray-100">{userDetails?.following_count || 0}</p>
                    ...
                    <div className="bg-purple-50 dark:bg-gray-700/50 rounded-lg p-4 text-center">
                      ...
                      <p className="text-lg font-bold text-gray-800 dark:text-gray-100">{userDetails?.posts_count || userPosts.length || 0}</p>
                    ...
                    <div className="bg-purple-50 dark:bg-gray-700/50 rounded-lg p-4 text-center">
                      ...
                      <p className="text-lg font-bold text-gray-800 dark:text-gray-100">{userDetails?.comments_count || 0}</p>
                      <p className="text-[10px] text-gray-500 dark:text-gray-400">Comments</p>
                    </div>
                    <div className="bg-purple-50 dark:bg-gray-700/50 rounded-lg p-4 text-center">
                      <Users className="w-6 h-6 text-purple-600 dark:text-purple-400 mx-auto mb-1.5" />
                      <p className="text-lg font-bold text-gray-800 dark:text-gray-100">{userDetails?.communities_count || userCommunities.length || 0}</p>
              ...
              {activeTab === 'actions' && user && (
                <div className="space-y-8 max-w-2xl mx-auto py-4">
                  <div>
                    <h3 className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-4 uppercase tracking-wider">Account Status</h3>
                    <div className="grid grid-cols-2 gap-4">
                      <button
                        onClick={() => setPendingStatus('Active')}
                        className={`flex items-center justify-center gap-2 px-4 py-3 rounded-xl border-2 transition-all ${pendingStatus === 'Active'
                          ? 'border-purple-600 bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300'
                          : 'border-gray-100 dark:border-gray-700 text-gray-500 hover:border-purple-200'
                          }`}
                      >
                        <CheckCircle size={18} className={pendingStatus === 'Active' ? 'text-purple-600' : ''} />
                        <span className="font-semibold text-sm">Active</span>
                      </button>
                      <button
                        onClick={() => setPendingStatus('Inactive')}
                        className={`flex items-center justify-center gap-2 px-4 py-3 rounded-xl border-2 transition-all ${pendingStatus === 'Inactive'
                      ...
                      >
                        <XCircle size={18} className={pendingStatus === 'Inactive' ? 'text-red-600' : ''} />
                  ...
                  <div>
                    <h3 className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-4 uppercase tracking-wider">User Role</h3>
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                      {['user', 'pro_user', 'admin'].map((role) => (
                        <button
                          key={role}
                          onClick={() => setPendingRole(role)}
                          className={`px-3 py-2.5 rounded-lg border-2 text-xs font-medium capitalize transition-all ${pendingRole === role
                            ? 'border-purple-600 bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300'
                            : 'border-gray-100 dark:border-gray-700 text-gray-500 hover:border-purple-200'
                            }`}
                        >
                  ...
                  <div>
                    <h3 className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-4 uppercase tracking-wider">Verification</h3>
                    <button
                      onClick={() => setPendingIsVerified(!pendingIsVerified)}
                      className={`w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl border-2 transition-all ${pendingIsVerified
                    ...
                    >
                      ...
                      <span className="font-semibold text-sm">{pendingIsVerified ? 'Verified' : 'Mark as Verified'}</span>
                    </button>
                  </div>
                </div>
              )}
