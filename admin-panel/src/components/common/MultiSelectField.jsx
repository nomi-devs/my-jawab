    ...
    return (
        <div className="relative" ref={wrapperRef}>
            ...
            <div
                ...
                className={`min-h-[40px] w-full px-3 py-1.5 rounded-lg border border-purple-200 dark:border-gray-600 dark:bg-gray-700 text-sm flex items-center gap-1 flex-wrap cursor-pointer transition-all ${disabled
                            ...
                            filteredOptions.map(opt => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full flex items-center justify-between gap-2 px-3 py-2 text-xs text-left hover:bg-purple-50 dark:hover:bg-gray-700 transition-colors ${isSelected ? 'bg-purple-50/50 dark:bg-gray-700/50' : ''
                                            }`}
                                    >
