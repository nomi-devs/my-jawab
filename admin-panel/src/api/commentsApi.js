...
const commentsApi = {
  ...
  getComments(params = {}) {
    ...
    const queryParams = {
      ...
      ...(params.is_approved !== undefined && params.is_approved !== null && { is_approved: params.is_approved }),
      ...(params.post_id && { post_id: params.post_id }),
      ...(params.user_id && { user_id: params.user_id }),
      ...(params.has_replies !== undefined && params.has_replies !== null && { has_replies: params.has_replies }),
