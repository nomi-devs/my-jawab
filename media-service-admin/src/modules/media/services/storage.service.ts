...
export class StorageService {
  ...
  private getLocalFileUrl(filePath: string): string {
    ...
    const appConfig = this.configService.get<{ url?: string }>('app');
    const baseUrl = appConfig?.url || 'https://demo.jantrah.com/jawaab-media';
    return `${baseUrl}/api/media/files/${filePath}`;
  }
